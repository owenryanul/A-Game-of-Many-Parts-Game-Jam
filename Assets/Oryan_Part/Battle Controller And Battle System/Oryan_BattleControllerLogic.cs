...
public class Oryan_BattleControllerLogic : TurnTaker, FadeEffectsListener, OnDeathListener
{
    ...
    void Start()
    {
        ...
        turnIndicator = GameObject.FindGameObjectWithTag("oryan_turnText");
    ...
    public void startBattle(GameObject overworldInstigatorIn, GameObject[] enemies, bool extendFightEnding = false)
    {
        ...
        turnIndicator.GetComponentInChildren<TextMeshProUGUI>().text = "Player's Turn";
    ...
    public void endBattle()
    {
        ...
        turnIndicator.GetComponentInChildren<TextMeshProUGUI>().text = "";
    }
    ...
    public void nextTurn()
    {
        ...
        turnIndicator.GetComponent<Animator>().SetTrigger("Switch");
    }
    ...
    public TurnTaker getNextTurnTaker()
    {
        ...
        {
            return turnTakers[currentTurnIndex + 1];
        }
    }
