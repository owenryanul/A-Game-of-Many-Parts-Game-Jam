...
public class RecallArrowProjectileScript : MonoBehaviour, OnActivateListener
{
    ...
    {
        isRecalling = false;
        GameObject.FindGameObjectWithTag("base_player").GetComponent<Player_Logic>().addOnActivateListener(this);
    }
