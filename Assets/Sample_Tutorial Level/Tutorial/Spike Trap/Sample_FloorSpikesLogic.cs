...
public class Sample_FloorSpikesLogic : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (tripped && spikesAreOut && collision.tag == "base_player" && !collision.gameObject.GetComponent<PlayerLogic>().getIsDodging())
        {
    ...
    {
        PlayerLogic player = GameObject.FindGameObjectWithTag("base_player").GetComponent<PlayerLogic>();
        spikesAreOut = true;
