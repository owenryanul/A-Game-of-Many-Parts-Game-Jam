...
public class tutorial_basicEnemyLogic : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.tag == "base_player" && !player.GetComponent<Player_Logic>().getIsDodging())
        {
            //Die to player
            player.GetComponent<Player_Logic>().addHp(-1, true);
            die();
        }
