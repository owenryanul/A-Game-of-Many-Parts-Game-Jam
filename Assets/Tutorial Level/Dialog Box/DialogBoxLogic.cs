...
public class DialogBoxLogic : MonoBehaviour, Interactable
{
    ...
    void Update()
    {
        if (dialogBoxVisible)
        {
            GameObject.FindGameObjectWithTag("base_player").GetComponent<Player_Logic>().setCurrentInteractable(this);
        }
    }
